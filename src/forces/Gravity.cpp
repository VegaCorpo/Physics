...
//? Public methods
void physics::forces::Gravity::apply(common::WorldState& world, double /*dt*/)
{
    // TODO apply gravity
...
void physics::forces::Gravity::_computeGravity(common::WorldState& world, const size_t count)
{
    ...
    //      [=](size_t i)
    //      {
    //          components::ForceAccumulator* __restrict forceAcc =
    //          *group.storage<components::ForceAccumulator>()->raw(); const double myPx = posX[i].value; const double
    //          myPy = posY[i].value; const double myPz = posZ[i].value; const double myMassG = mass[i].value * G;
    //
    //          double accFx = 0.0;
    //          double accFy = 0.0;
    //          double accFz = 0.0;
